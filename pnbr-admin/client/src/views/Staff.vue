        ...
        <div class="search-box">
          ...
          >
            <el-form-item label="关键词:">
              <el-input type="text" v-model="search_data.phone" placeholder="请输入关键词"></el-input>
            </el-form-item>
            <el-form-item>
           ...
           <el-table
            ...
            <el-table-column
             ...
             <el-table-column
                ...
                width="180">
                <template slot-scope="scope">
                    <span style="margin-left: 10px">{{ scope.row.keyNum }}</span>
                </template>
            </el-table-column> 
            <el-table-column
                label="创建时间"
  ...
  methods: {
    ...
    exportToExcel() {
      ...
      require.ensure([], () => {
        ...
        const tHeader = ["头像","用户名", "手机号码", "角色", "创建时间"];
        const filterVal = ["avatarImage", "username", "phone", "role", "createTime"];
