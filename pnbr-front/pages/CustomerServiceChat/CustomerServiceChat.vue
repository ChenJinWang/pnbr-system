<template>
	<view class="container">
		<view style="position: fixed;top: 0rpx;text-align: center;z-index: 99;background-color: #666;width: 100%;">
			<view style="text-align: center;padding-top: 20rpx;font-size: 40rpx; color: #ffffff; padding-bottom: 20rpx;">{{toUsername}}</view>
		</view>
	...
	export default {
		data() {
			return {
				...
				toUserId: 'admin7',
				toUsername: '客服中心',
				toAvatarimage: '../../static/images/icon/head.png',
				user: {},
				fromUserId: 0,
				a: 0,
