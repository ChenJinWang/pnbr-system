		        ...
		        <view class="prod-items" @tap="toProdPage" :data-prodid="prod.id">
		          ...
		          <view class="hot-text">
		            ...
		            <view class="prod-text-info">
		              ...
		              <image src="/static/images/tabbar/shoppingcarts.png" class="ShoppingCart-img"></image>
		            </view>
		          </view>
		        </view>
		      </block>
  ...
  methods: {
    ...
    getIndexImgs() {
	  ...
	  this.setData({
	    indexImgs: [
			{
				imgUrl: "/static/images/index/banner/banner_b.jpeg",
				relation: 1
			},
			{
				imgUrl: "/static/images/index/banner/banner_a.jpeg",
				relation: 2
			},
			{
				imgUrl: "/static/images/index/banner/banner_m.jpeg",
				relation: 3
			}
		],
	    seq: [
