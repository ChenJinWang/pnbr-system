<template>
	<view class="container">
		...
		<view class="input-box">
		  ...
		  <view class="section">
		    <text>规格</text>
		    <input placeholder="请输入规格" type="text" maxlength="11" :value="pet.specification" @input="onSpecificationInput"></input>
		  </view>
		  ...
		  <view class="section">
		    <text>价格</text>
		    <input placeholder="请输入价格" type="number" :value="pet.price" @input="onPriceInput"></input>
		  </view>
		  <view class="section">
	...
	export default {
		...
		methods: {
			...
			onSpecificationInput: function (e) {
				this.setData({
				  'pet.specification': e.detail.value
				});
			},
			...
			onSubmiti: function () {
				...
				if(!this.pet.specification||typeof(this.pet.specification) == "undefined") {
					uni.showToast({
						title: "规格不能为空",
						icon: 'none',
					});
				...
				if(!this.pet.price||typeof(this.pet.price) == "undefined") {
					uni.showToast({
						title: "价格不能为空",
						icon: 'none',
					});
				...
				var params = {
				  ...
				  data: {
					    ...
					    specification: this.pet.specification,
