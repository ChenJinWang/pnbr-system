	...
	<view class="container">
		<view class="userinfo" v-if="isAuthInfo" @tap="toUserInfoPage">
			<view class="userinfo-con">
				<view class="userinfo-avatar">
					...
					<image :src="loginResult.data.avatarImage?serverUrl+loginResult.data.avatarImage:'../../static/images/icon/head.png'"></image>
				</view>
		...
		<view class="userinfo-none" v-if="!isAuthInfo">
			<view class="default-pic">
				<image src="../../static/images/icon/head.png"></image>
			</view>
		...
		<view class="list-cont">
			...
			<view class="my-menu">
				<view class="memu-item" @tap="tosjuserRelease">
					<view class="i-name">
						<image src="/static/images/icon/sjuser.png"></image>
						<text>商家发布</text>
					</view>
					<view class="arrowhead"></view>
				</view>
				<view class="memu-item" @tap="toybuserRelease">
					<view class="i-name">
						<image src="/static/images/icon/ybuser.png"></image>
						<text>发布帖子</text>
					</view>
					<view class="arrowhead"></view>
				</view>
				...
				<view class="memu-item" @tap="toFeedbackCenter">
					<view class="i-name">
						<image src="/static/images/icon/mycomplaint.png"></image>
						<text>我反馈的</text>
					</view>
					<view class="arrowhead"></view>
				</view>
				<view class="memu-item" @tap="toChatListPage">
					<view class="i-name">
				...
				<view class="memu-item" @tap="toMyComplaintPage">
					<view class="i-name">
						<image src="/static/images/icon/myfeedback.png"></image>
						<text>反馈中心</text>
					</view>
					<view class="arrowhead"></view>
				</view>
				...
				<view class="memu-item" @tap="toCustomerServiceChats">
					<view class="i-name">
						<image src="/static/images/icon/systemChat.png"></image>
						<text>联系客服</text>
					</view>
					<view class="arrowhead"></view>
				</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			tosjuserRelease: function() {
				uni.navigateTo({
					url: '../releaseCommodities/releaseCommodities'
				});
			},
			toybuserRelease: function() {
				uni.navigateTo({
					url: '../userReleaseCommodities/userReleaseCommodities'
				});
			},
			...
			toChatListPage: function(e) {
				var sts = e.currentTarget.dataset.sts;
				uni.navigateTo({
					url: '/pages/messageList/messageList'
				});
			},
			toMyComplaintPage: function(e) {
				var sts = e.currentTarget.dataset.sts;
				uni.navigateTo({
			 ...
			 * 咨询客服
			 */
			toCustomerServiceChats: function (e) {
				  ...
				  const toAvatarimage = e.currentTarget.dataset.fromavatarimage;
			        uni.navigateTo({
			          url: '/pages/CustomerServiceChat/CustomerServiceChat?toUserId='+27+'&toUsername='+'系统客服'+"&toAvatarimage="+toAvatarimage
			  });
			},
