...
<view class="container">
  ...
  <view class="search-bar">
    <view class="search-box">
      <input placeholder="输入帖子关键字搜索" class="sear-input" confirm-type="search" @confirm="toSearchProdPage" @input="getSearchContent" :value="prodName"></input>
  ...
  methods: {
    ...
    toSearchProdPage: function () {
      if (this.prodName.trim()) {
        ...
        uni.navigateTo({
          url: '/pages/search-community-show/search-community-show?prodName=' + this.prodName
        });
      }
    },
...
<style>
@import "./search-community-page.css";
</style>