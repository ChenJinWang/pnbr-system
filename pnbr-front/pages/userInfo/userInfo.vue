<template>
	<view class="container">
		...
		<view class="input-box">
		  <view class="section">
		    <text>头像</text>
		    <image style="width: 130rpx;height: 130rpx;padding-left: 55%;" @tap="upload" :src="userInfo.avatarImage?serverUrl+userInfo.avatarImage:'../../static/images/icon/head.png'"></image>
		  </view>
		  <view class="section">
		    <text>手机号码</text>
